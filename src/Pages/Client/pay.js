...
<div className="container-xxl py-5 px-0 wow fadeInUp"
      ...
      <div className="row">
        ...
        <div className="col-md-5">
          <div className="p-4 bg-white shadow-sm mb-3">
            ...
            <p className="mb-0 fw-bold">332, Đường Trần Hoàng Na, Phường Hưng Lợi, Quận Ninh Kiều, Cần Thơ</p>
          </div>
        </div>
  ...
  <div className="d-flex justify-content-between align-items-center mt-3">
    ...
    <p className="mb-0 fw-bold text-end">Thời gian tạo đơn: 19/08/2023 12:05</p>
  </div>
  ...
  <p className="fw-bold">Số người: 02 người</p>
      ...
      <div className="col-md-7">
        <h5 className="fw-bold mb-3" style={{ color: "#ff9f1a" }}>Đơn hàng (2 sản phẩm)</h5>
    <hr />
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="d-flex flex-column">
          ...
          <div className="d-flex align-items-center mt-1">
            <span className="badge bg-warning rounded-circle" style={{ marginRight: "8px" }}>1</span>
  ...
  {/* Repeat the order item for other products */}
  <div className="bg-white shadow-sm mb-2 p-3">
    <div className="d-flex justify-content-between align-items-center">
      <div className="d-flex align-items-center">
        <img
      ...
      />
      <button className="btn btn-primary" type="button" id="apply-voucher">
        Áp dụng
      </button>
        </div>
            ...
            <div className="d-flex justify-content-between align-items-center mt-3">
  <NavLink to="/order" className="btn btn-dark"><i className="fa-solid fa-chevron-left"></i> Quay lại chọn món</NavLink>
  <NavLink to="/confirm" className="btn btn-primary py-2">Đặt bàn</NavLink>
</div>
