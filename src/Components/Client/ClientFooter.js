                ...
                <div className="container py-5">
                    <div className="row g-5">
                        ...
                        <div className="col-lg-3 col-md-6">
                            ...
                            <p className="mb-2"><i className="fa fa-map-marker-alt me-3"></i>Số 82, đường Lê Bình, Quận Ninh Kiều, TP.Cần Thơ</p>
                            <p className="mb-2"><i className="fa fa-phone-alt me-3"></i>078.546.8567</p>
                            <p className="mb-2"><i className="fa fa-envelope me-3"></i>contact.huongsen@gmail.com</p>
                    ...
                    <div className="copyright">
                        <div className="row">
                            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                                &copy; <a className="border-bottom" href="#">Hương Sen Restaurant</a>, All Right Reserved.
                            </div>
